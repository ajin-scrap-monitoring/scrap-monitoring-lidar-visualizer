...
test "$(jq -r '.root_has_top_preview' "${probe_root}/output/live/live.json")" = "true"
test "$(jq -r '.top_frame_status' "${probe_root}/output/live/live.json")" = "200"
test "$(jq -r '.top_frame_revision' "${probe_root}/output/live/live.json")" = \
  "$(jq -r '.frame_revision' "${probe_root}/output/live/live.json")"
test "$(jq -r '.top_frame_sequence' "${probe_root}/output/live/live.json")" = \
